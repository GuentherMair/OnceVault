...
to 15 lines then scroll — see PLAN_STEP_4) · i18n: 27 languages (en default/fallback,
all other official EU languages, plus Turkish, Korean, and Mandarin), browser-language start, globe-icon picker,
